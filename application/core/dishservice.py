...
def create_dish(name, name_uz, description, description_uz, image, price, quantity, category_id, show_usd=False, sale_price=None):
    check_quantity = ''
...
def update_dish(dish_id, name, name_uz, description, description_uz, image, price, category_id, delete_image, show_usd, quantity, is_sale, sale_price):
