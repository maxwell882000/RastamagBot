...
Revision ID: 9914f1261c9e
Revises: 0c507bd10bd4
Create Date: 2020-10-20 20:37:40.763027
...
revision = '9914f1261c9e'
down_revision = '0c507bd10bd4'
branch_labels = None
depends_on = None
...
def upgrade():
    ...
    sa.Column('description_uz', sa.String(length=1500), nullable=True),
